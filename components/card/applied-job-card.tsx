  ...
  return (
    <div className="flex gap-4">
      <Card>
        ...
        <CardContent className="p-4">
          <div className="flex flex-col gap-4">
            <h2 className="font-semibold text-brand text-lg">Tokopedia</h2>
            <Link
              href=""
      ...
      <Card>
        ...
        <CardContent className="p-4">
          <div className="flex flex-col gap-4">
            <h2 className="font-semibold text-brand text-lg">Shopee</h2>
            <Link
              href=""
              className="font-bold text-2xl line-clamp-2 hover:text-brand hover:-translate-y-1 transition-all duration-500"
            >
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-2">
                <Clock5 className="w-5 h-5 text-brand" />
                <p className="text-muted-foreground uppercase">PART TIME</p>
              </div>
            </div>
          </div>
        </CardContent>
